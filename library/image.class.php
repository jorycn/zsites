...
{
$temp_png = $this->waterpng ?$this->waterpng : SSROOT.'/admin/'.WATERMARK_PNG;
$watermark_file = $this->watermarktype == 1 ?$temp_png : SSROOT.'/admin/images/mark.gif';
