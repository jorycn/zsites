...
<?php
    foreach ($downloads as $download) {
		$download->name=replacesitekey(MAINKEY,SITEKEY,DOMAINKEY,$download->name);
		$download->description=replacesitekey(MAINKEY,SITEKEY,DOMAINKEY,$download->description);
