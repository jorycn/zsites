...
$curr_article->title=replacesitekey(MAINKEY,SITEKEY,DOMAINKEY,$curr_article->title);
$curr_article->content=replacesitekey(MAINKEY,SITEKEY,DOMAINKEY,$curr_article->content);
?>
...
<table><tr><td align="left" height="50" width="800"><?php echo $nextAndPrevArr; ?></td></tr>
</table>