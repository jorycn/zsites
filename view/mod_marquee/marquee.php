...
$marquee->title=replacesitekey(MAINKEY,SITEKEY,DOMAINKEY,$marquee->title);
...
<p><a href="<?php echo Html::uriquery('mod_product', 'view', array('p_id' => $marquee->link)); ?>" title="<?php echo $marquee->title; ?>"><img src="<?php echo $marquee->pic?>" border=0 width="160" height="120"  name="picautozoom"></a></p>
<?php }else{?>
<?php 
// 21/09/2010
...
?>
<p>
<font style="font-size:12px;"><a href="<?php echo $uri; ?>" title="<?php echo $marquee->title; ?>"><img src="<?php echo $marquee->pic?>" border=0 width="160" height="120" name="picautozoom" ></a></font><br>
