...
<?php } ?>
   ...
   ?>
      ...
      <div class="nav" style="display:none;">
        <ul>
          ...
          <?php
            ...
            ?>
          <li><a href="" class="navlink" onClick="popup_window('admin/index.php?_m=mod_site&_a=admin_seo','<?php _e('SEO Set');?>',false,false,true);return false;"><img src="images/help9.gif" /><?php _e('SEO Set');?></a></li>
          <?php } ?>
		<?php
	...
	<?php }?>
          ...
          <li><a href="http://help.jzbao.net" target='_blank' class="navlink"><img src="images/help8.gif" /><?php _e('Help');?></a></li>
          <?php } ?>
        </ul>
      </div>
    </li>
