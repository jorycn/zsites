...
<title><?php
$_page_cat='';
if(isset($page_cat)) $_page_cat=$page_cat; 
if ($page_title<>"首页"){
	$page_title=$page_title.'-';
	echo replacesitekey(MAINKEY,SITEKEY,DOMAINKEY,isset($page_title)?$page_title:$_page_cat); 
}
if(empty($result->title)){
	$page_title=$_SITE->site_name;
	echo replacesitekey(MAINKEY,SITEKEY,DOMAINKEY,$page_title); 
}
echo $page_cat;
?></title>
<meta name="keywords" content="<?php echo replacesitekey(MAINKEY,SITEKEY,DOMAINKEY,$site_key);?>" />
<meta name="description" content="<?php echo replacesitekey(MAINKEY,SITEKEY,DOMAINKEY,$site_description);?>" />
