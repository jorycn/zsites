...
if (file_exists(ROOT.'/file/'.THISSITE.'/file/'.$curr_download->name)) {
unlink(ROOT.'/file/'.THISSITE.'/file/'.$curr_download->name);
}
}
}else {
...
if(file_exists(ROOT.'/file/'.THISSITE.'/file/'.$file_info["name"])) {
