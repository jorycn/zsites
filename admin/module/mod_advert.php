...
$width = '100';
$height = '300';
$text = $this->auto_break_line($site_param['ADVERT_TEXT']);
$text2 = $this->auto_break_line($site_param['ADVERT_RTEXT']);
break;
}
$xml = '../data/adtool/xml/config.xml';
...
$responsexml = "$adtext";
$this->createXml($xml,$responsexml);
if( $type == '3') {
$xml2 = '../data/adtool/xml/couplet.xml';
...
$responsexml2 = "$adtext2";
$this->createXml($xml2,$responsexml2);
}
}
die("<script type='text/javascript'>parent.window.location.reload();</script>");
}
}
