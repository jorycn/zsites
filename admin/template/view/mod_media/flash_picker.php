...
function do_pick(flash_path) {
	var rel_path = "file/<?php echo THISSITE; ?>/flash/" + flash_path;
				    	...
				    	?>
				            <td width="<?php echo intval(100 / $cols); ?>%">
				            	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="80" height="80">
									<param name="movie" value="file/<?php echo THISSITE; ?>/flash/<?php echo $curr_entry.$files[$i];?>" />
									<param name="quality" value="high" />
									<embed src="file/<?php echo THISSITE; ?>/flash/<?php echo $curr_entry.$files[$i];?>" width="80" height="80" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash"></embed>
								</object>
				            	<br />
				            	<span class="small">
