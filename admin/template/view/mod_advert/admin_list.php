...
<table class="form_table" width="100%" border="0" cellspacing="0" cellpadding="2" style="line-height:24px;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <?php
            echo Html::input('hidden', 'sparam[ADVERT_THEME]', ADVERT_THEME);
        ...
        <tr>
            ...
            <td class="entry">
            <?php
            echo Html::textarea('sparam[ADVERT_TEXT]', ADVERT_TEXT, 'rows="3" cols="50" class="textinput"');
        ...
        <tr>
            ...
            <td class="entry">
            <?php
            echo Html::input('text', 'sparam[ADVERT_TEXT_SIZE]', ADVERT_TEXT_SIZE, 'class="textinput" style="width:50px"');
            ?></td>
        </tr>
       	<tr>
			...
			<span class="show_left"><?php echo '('.__('left').')'; ?></span></td>
            <td class="entry">
            <input type="text" name="sparam[ADVERT_TEXT_COLOR]" class="textinput" style="width:80px" value="<?php echo ADVERT_TEXT_COLOR;?>" onchange="updatecolorpreview('c1')" id="c1_v">
        ...
        <tr>
            ...
            <?php
            $check = '';
            echo Html::input('text', 'sparam[ADVERT_URL]', ADVERT_URL, 'class="textinput"');
            echo '<br />';
        ...
        <tr>
            ...
            <?php
            echo Html::input('hidden', 'sparam[ADVERT_RTHEME]', ADVERT_RTHEME);
        ...
        <tr>
            ...
            <td class="entry">
            <?php
            echo Html::textarea('sparam[ADVERT_RTEXT]', ADVERT_RTEXT, 'rows="3" cols="50" class="textinput"');
            if(SessionHolder::get('_LOCALE', DEFAULT_LOCALE) != 'en') {
            ?>            
        ...
        <tr>
            ...
            <td class="entry">
            <?php
            echo Html::input('text', 'sparam[ADVERT_RTEXT_SIZE]', ADVERT_RTEXT_SIZE, 'class="textinput" style="width:50px"');
            ?></td>
        </tr>
       	<tr>
        	<td class="label"><?php _e('Advert Text Color');echo '('.__('right').')'; ?></td>
            <td class="entry">
            <input type="text" name="sparam[ADVERT_RTEXT_COLOR]" class="textinput" style="width:80px" value="<?php echo ADVERT_RTEXT_COLOR;?>" onchange="updatecolorpreview('c2')" id="c2_v">
        ...
        <tr>
            ...
            <?php
            $check = '';
            echo Html::input('text', 'sparam[ADVERT_RURL]', ADVERT_RURL, 'class="textinput" size="25"');
            echo '<br />';
