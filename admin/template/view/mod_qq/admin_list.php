...
?><input type="hidden" name="tjok" value="1" /><span id="online_input" style="display:none;"><?php
...
<?php } else{?>
				<IMG src="http://wpa.qq.com/pa?p=2:<?php echo $qq->account; ?>:17" align=absMiddle border=0><a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $qq->account; ?>&site=qq&amp;Menu=yes" target=blank><?php echo $qq->account; ?></A>
			<?php } ?>
