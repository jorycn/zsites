...
<?php } else { ?>
	<img src="http://wpa.qq.com/pa?p=2:<?php echo $qq->account; ?>:17" align=absMiddle border=0><a href="tencent://message/?uin=<?php echo $qq->account; ?>&amp;Menu=yes" target=blank><?php echo $qq->account; ?></a>
    <div class="space4"></div>
<?php } } } ?>
</div>