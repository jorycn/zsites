...
?>
		<div id="top1_tit"><img src="<?php echo P_TPL_WEB; ?>/images/ZSites_logo.gif" width="503" height="22" alt="logo" /></div>
        
        <div id="center1">
        <div class="xx"></div><br>
        <h1>通过使用向导，我们将帮助您快速掌握操作方法，大大缩短建站时间。</h1>
        <h2>完成网站设置后，建议您了解一下ZSites提供的更多高级功能，这些将帮助您有效提升网站的前台表现。</h2><br />
        <div class="xx"></div>
        <h1>您还可以通过以下方式来获得帮助：</h1>
        <a class="icon1">小提示：鼠标滑过会看到注释说明</a><a class="icon2" href="#" style="text-decoration:none;cursor:default;">ZSites帮助中心     <span style="color:#000;"><a target="_blank" href="http://help.jzbao.net">http://help.jzbao.net</a></span></a><br /><br />
        <div class="xx"></div>
