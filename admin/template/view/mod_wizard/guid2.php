...
?>        	
        ...
        <div class="xx"></div>
        <h1>2、设置在线客服(可选)</h1>
        <h2>ZSites为您提供多种常用的在线沟通工具，包括&nbsp;<span id="center_qq">&nbsp;</span>QQ、<span id="center_msn">&nbsp;</span>MSN、<span id="center_ww">&nbsp;</span>淘宝旺旺、<span id="center_53kf">&nbsp;</span>53客服等<br />方便顾客和您即时在线交流。<br /><a target="_blank" href="<?php echo Html::uriquery('mod_qq', 'admin_list'); ?>">开始设置</a></h2>
        <div class="xx"></div>
