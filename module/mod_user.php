...
if(UC_OPEN>0){
if (uc_user_checkemail($user_info['email'])==-6){
$this->assign('json',Toolkit::jsonERR(__('Invalid Password!')));
return '_result';
}
if (uc_user_edit($o_user->login ,"","",$user_info['email'],1,0 ,"")<0){
$this->assign('json',Toolkit::jsonERR(__('Missing user information!')));
return '_result';
}
}
...
if (uc_user_edit($o_user->login ,"",$passwd_info['passwd'] ,"",1,0 ,"")<0){
$this->assign('json',Toolkit::jsonERR(__('Missing user information!')));
return '_result';
}
...
if(UC_OPEN>0){
if (uc_user_checkemail($user_info['email'])!=1) {
$this->assign('json',Toolkit::jsonERR(__('User E-mail address exists!')));
return '_result';
}
if (uc_user_register($user_info['login'],$user_info['passwd'],$user_info['email'])<=0){
$this->assign('json',Toolkit::jsonERR(__('Missing user information!')));
return '_result';
}
}
